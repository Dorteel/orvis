...
def measure_time_to_csv(csv_filename):
    def decorator(func):
        @wraps(func)
        def wrapper(*args, **kwargs):
            ...
            # Append the timing to the CSV file
...
@measure_time_to_csv("annotator_query_results.csv")
...
@measure_time_to_csv("location_query_results.csv")
